...
class PreviousYearPage extends StatefulWidget {
  static const String id = "Previous_year";
  @override
  _PreviousYearPageState createState() => _PreviousYearPageState();
}

class _PreviousYearPageState extends State<PreviousYearPage> {
  ...
  void getExamNames(String ExamName) async {
    ...
    await firestoreInstance.collection("PreviousYearSubjectWise").where("ExamName", isEqualTo: ExamName).getDocuments().then((
        querySnapshot) {
      querySnapshot.documents.forEach((result) {
        print(result.data["SubjectName"]);
